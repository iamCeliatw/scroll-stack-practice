    ...
    (function(global3, factory) {
      ...
      var sha256 = function sha2562(ascii) {
        ...
        for (j3 = 0; j3 < words[lengthProperty]; ) {
          var w6 = words.slice(j3, j3 += 16);
          var oldHash = hash;
          hash = hash.slice(0, 8);
          for (i6 = 0; i6 < 64; i6++) {
            var i22 = i6 + j3;
            var w15 = w6[i6 - 15], w22 = w6[i6 - 2];
            var a11 = hash[0], e10 = hash[4];
            var temp1 = hash[7] + (rightRotate(e10, 6) ^ rightRotate(e10, 11) ^ rightRotate(e10, 25)) + (e10 & hash[5] ^ ~e10 & hash[6]) + k5[i6] + (w6[i6] = i6 < 16 ? w6[i6] : w6[i6 - 16] + (rightRotate(w15, 7) ^ rightRotate(w15, 18) ^ w15 >>> 3) + w6[i6 - 7] + (rightRotate(w22, 17) ^ rightRotate(w22, 19) ^ w22 >>> 10) | 0);
            var temp2 = (rightRotate(a11, 2) ^ rightRotate(a11, 13) ^ rightRotate(a11, 22)) + (a11 & hash[1] ^ a11 & hash[2] ^ hash[1] & hash[2]);
...
function any(arr) {
  ...
  return new P3(function(resolve2, reject2) {
    ...
    for (var i6 = 0; i6 < args.length; i6++) {
      try {
        P3.resolve(args[i6]).then(resolve2).catch(function(error) {
...
function isArray(x5) {
  return Boolean(x5 && typeof x5.length !== "undefined");
}
function noop() {
}
...
function u2(n6, t2) {
  ...
  for (var r10 = n6.split("."), e10 = t2.split("."), o7 = Math.max(r10.length, e10.length), i6 = 0; i6 < o7; i6++) {
    ...
    var a11 = parseInt(r10[i6]) - parseInt(e10[i6]);
    if (0 !== a11)
      return a11 > 0 ? 1 : -1;
  }
  return 0;
...
function f(t2) {
  ...
  }(r10[0]), o7 = p2(r10[1]), i6 = p2(r10[2]), a11 = p2(r10[3]);
  return "rgba(".concat(o7, ", ").concat(i6, ", ").concat(a11, ", ").concat(e10, ")");
}
function p2(n6) {
...
function s3(t2) {
  ...
  var e10 = p2(r10[0]), o7 = p2(r10[1]), i6 = p2(r10[2]);
...
var l3 = { get: function(n6) {
  ...
  if (e10)
    for (var i6 in e10) {
      var a11 = e10[i6] ? "=".concat(e10[i6]) : "";
      o7 += "; ".concat(i6).concat(a11);
    }
...
var v = /* @__PURE__ */ new Set(["400", "401", "403", "404", "429", "500"]);
var g = function(n6) {
  function r10(t2, r11) {
...
var b = { parse: function(n6) {
  return n6.replace(/^\?/, "").replace(/^#\/?/, "").split(/&+/).filter(function(n7) {
    return n7.length > 0;
  }).reduce(function(n7, t2) {
    var e10 = __read(t2.split("=").map(decodeURIComponent), 2), o7 = e10[0], i6 = e10[1], a11 = n7[o7];
    return Array.isArray(a11) ? a11.push(i6) : Object.prototype.hasOwnProperty.call(n7, o7) ? n7[o7] = [a11, i6] : n7[o7] = i6, n7;
  }, {});
...
function C2(n6) {
  var t2 = new URL(n6);
  return t2.toString().replace(new RegExp(String.raw(j || (j = __makeTemplateObject(["^", ""], ["^", ""])), t2.origin)), "");
}
var j;
var x = function(n6) {
  var t2 = C2(U(n6));
...
function O2(n6) {
  var t2, r10 = n6.match((t2 = s2.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), new RegExp("^".concat(t2, "(\\d+-\\w+)"))));
  return r10 && r10[1];
}
function S2(n6) {
...
var c4 = null;
function u3() {
  return null === c4 && (c4 = F2() || $() && /[#|&]access_token=/.test(location.hash) || "1" === sessionStorage.getItem("".concat(l2, ":").concat(D)), sessionStorage.setItem("".concat(l2, ":").concat(D), c4 ? "1" : "0")), !!c4;
}
var f2 = function(n6) {
  function o7() {
...
function a4(n6, t2) {
  if (!t2)
    throw h(T, "liffId is necessary for liff.init()");
...
function q(n6) {
  var t2 = c5();
  l3.set("".concat(l2, ":").concat(r3.EXPIRES, ":").concat(t2.liffId), n6.getTime(), { expires: n6.toUTCString(), path: "/", secure: null });
}
function z() {
  var n6 = c5();
  return l3.get("".concat(l2, ":").concat(r3.EXPIRES, ":").concat(n6.liffId));
}
function Y() {
  var n6 = c5();
  l3.remove("".concat(l2, ":").concat(r3.EXPIRES, ":").concat(n6.liffId), { path: "/" });
}
function Z() {
...
var l5 = function(n6) {
  function i6() {
    ...
    return u3() ? t2.impl = new c6() : t2.impl = new a5(window.sessionStorage), t2;
  }
...
function v3(e10, n6) {
  ...
  if (u3()) {
    var l12 = function(e11, i6) {
      var n7 = r5();
      return !!n7 && !(i6 && u2(n7, i6) > 0) && u2(n7, e11) >= 0;
    }(o7, t2);
...
var b3 = function() {
  return e3() ? !F2() && $() ? { available: false, error: { code: E, message: "Subwindow is not supported in this browser" } } : d3() ? { available: false, error: { code: E, message: "this api can be only called in child window" } } : v3("subwindowOpen", true) : { available: false, error: { code: t, message: "Need access_token for api call, Please login first" } };
};
...
var w3 = function(e10) {
  return function() {
    var i6 = e10();
    if (!i6.available)
      throw h(i6.error.code, i6.error.message);
  };
};
...
var o3 = function() {
  function n6(o7) {
    u2(r4(), n6.SDK_VERSION_SUPPORTING_NEW) >= 0 ? this.impl = new e6() : this.impl = new r6(o7);
  }
...
function p5() {
  var t2;
  return "ios" === e7() ? (t2 = r5()) && u2(t2, "9.19.0") < 0 ? "https://static.line-scdn.net/liff/edge/2/ios-918-extensions_2_22_0.js" : "https://static.line-scdn.net/liff/edge/2/ios-extensions_2_22_0.js" : "https://static.line-scdn.net/liff/edge/2/non-ios-extensions_2_22_0.js";
}
function y3() {
  return a6() ? function() {
          ...
          case 2:
            return [2, new Promise(function(e11, o7) {
              ...
              r10.onload = function() {
                ...
                r11 ? e11(r11) : o7(h(i3, "Unable to load client features. (Extension is empty)"));
              }, r10.onerror = function() {
                o7(h(i3, "Unable to load client features."));
    ...
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          ...
          t2.label = 1;
        case 1:
          return t2.trys.push([1, 3, , 4]), [4, a11.json()];
        case 2:
          return [2, t2.sent()];
        case 3:
          return t2.sent(), [2, a11];
        case 4:
          return e10 = String(a11.status), r10 = v.has(e10) ? e10 : e2, [4, a11.json().catch(function() {
            throw h(r10, a11.statusText);
          })];
        case 5:
...
function p6(e10, t2) {
  ...
  return fetch(e10, a11);
}
function h4(e10) {
  var t2 = e10.subdomain, a11 = void 0 === t2 ? "api" : t2, n6 = e10.pathname;
  return "https://".concat(a11, ".").concat("line.me", "/").concat(n6);
}
...
var E4 = function(s11) {
  ...
  this.identification = { identifier: "", cryptoKey: "" }, this.messageHandlerInstance = null, this.listeners = /* @__PURE__ */ new Map(), this.sentMessages = [], this.generateIdentification = function() {
      ...
      return __generator(this, function(l12) {
        switch (l12.label) {
          case 0:
            ...
            }, o8 = this, u12 = { identifier: this.windowType === f5.MAIN ? I2(12) : e10.get("liff.subwindow.identifier") || s12("liff.subwindow.identifier") || "" }, this.windowType !== f5.MAIN ? [3, 2] : [4, __awaiter(void 0, void 0, void 0, function() {
              var e11, t2, r10;
              return __generator(this, function(n6) {
                switch (n6.label) {
                  case 0:
    ...
    return __awaiter(o7, void 0, void 0, function() {
      ...
      return __generator(this, function(n6) {
        switch (n6.label) {
          ...
          case 1:
            return r10.context = n6.sent(), t2 = r10, null === (a11 = null === (s12 = this.messageHandlerInstance) || void 0 === s12 ? void 0 : s12.contentWindow) || void 0 === a11 || a11.postMessage({ messageBusEvent: t2 }, "*"), this.sentMessages.push(y4(t2)), [4, new Promise(function(e11) {
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var r10, s12 = this;
      return __generator(this, function(a11) {
        return (r10 = i6.data.messageBusEvent) ? (this.sentMessages.includes(y4(r10)) || r10.identifier !== this.identification.identifier || r10.action !== u6.BROADCAST && !r10.replyTarget || this.listeners.forEach(function(i7) {
          return __awaiter(s12, void 0, void 0, function() {
            ...
            return __generator(this, function(n6) {
              switch (n6.label) {
                case 0:
                  return t2 = i7, s13 = [__assign({}, r10)], a12 = {}, [4, this.getDecryptedContext(r10.context)];
                case 1:
                  return t2.apply(void 0, [__assign.apply(void 0, s13.concat([(a12.context = n6.sent(), a12)]))]), [2];
              }
            });
          });
        }), [2]) : [2];
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, i6, r10, s12, a11, o8, c15;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, i6 = t2.identifier, r10 = t2.cryptoKey, a11 = (s12 = JSON).stringify, c15 = { eventName: e10.eventName, key: e10.key ? e10.key : void 0 }, e10.data ? [4, p7(i6, r10, JSON.stringify(e10.data))] : [3, 2];
          case 1:
            return o8 = n6.sent(), [3, 3];
          case 2:
            o8 = void 0, n6.label = 3;
          case 3:
            return [2, a11.apply(s12, [(c15.data = o8, c15)])];
        }
      });
    });
  }, this.getDecryptedContext = function(i6) {
    return __awaiter(o7, void 0, void 0, function() {
      var t2, r10, s12, a11, o8, c15, d7, u12;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, r10 = t2.identifier, s12 = t2.cryptoKey, (a11 = JSON.parse(i6)).data && "string" == typeof a11.data ? (u12 = (d7 = JSON).parse, [4, m6(r10, s12, a11.data)]) : [3, 2];
          case 1:
            return c15 = u12.apply(d7, [n6.sent()]), [3, 3];
          case 2:
            c15 = void 0, n6.label = 3;
          case 3:
            return o8 = c15, [2, __assign(__assign({}, a11), { data: o8 })];
        }
      });
    });
  }, this.windowType = s11;
...
!function() {
  if ("function" != typeof window.CustomEvent) {
    let t2 = function(t3, e10) {
      var i6 = e10 || {}, o7 = i6.bubbles, n6 = void 0 !== o7 && o7, a11 = i6.cancelable, r10 = void 0 !== a11 && a11, l12 = i6.detail, d7 = void 0 === l12 ? void 0 : l12, f12 = document.createEvent("CustomEvent");
...
function v6(t2) {
  ...
  try {
    ...
    throw h(I, r10.message);
  }
  var a11 = d5(i6);
  i.debug("[client dispatchEvent to js]", { type: a11.type, detail: a11.detail }), window.dispatchEvent(a11);
}
function p8(t2, a11, l12) {
  void 0 === a11 && (a11 = {}), void 0 === l12 && (l12 = "");
  var d7 = w2();
  if (!d7)
    throw h(E, "Invalid featureToken for client features");
  if (!window._liff || !window._liff.postMessage)
    throw h(I, "postMessage is not available from client");
  i.debug("[js postMessage to client]", t2, l12, a11), window._liff.postMessage(t2, d7, l12, JSON.stringify(a11));
}
function m7(t2, e10, d7) {
  return void 0 === e10 && (e10 = {}), void 0 === d7 && (d7 = { once: true }), w2() ? (d7 = __assign({ callbackId: I2(12), once: true }, d7), new Promise(function(i6, n6) {
    var a11 = function(e11) {
      if (e11 && e11.detail) {
        var r10 = e11.detail.callbackId === d7.callbackId, l12 = "string" != typeof e11.detail.callbackId;
        (r10 || l12) && (d7.once && u7(t2, a11), i.debug("[callback detail]", e11.detail), e11.detail.error ? n6(e11.detail.error) : e11.detail.data ? i6(e11.detail.data) : n6(e11.detail));
      }
      n6();
    };
    s6(t2, a11), p8(t2, e10, d7.callbackId);
...
function r8() {
  var o7 = r5();
  null !== o7 && ("ios" === e7() && u2(o7, "9.19") >= 0 || "android" === e7() && u2(o7, "11.6.0") >= 0) ? location.href = "liff://close" : window._liff && window._liff.postMessage ? null !== o7 && u2(o7, "10.15.0") >= 0 ? "ios" === e7() ? window._liff.postMessage("closeWindow", "") : window._liff.postMessage("closeWindow", "", "", "") : m7("closeWindow") : window.close();
}
var l8 = function(i6) {
  function n6() {
...
function ue(n6, r10) {
  return void 0 === r10 && (r10 = {}), __awaiter(this, void 0, void 0, function() {
    var e10, i6, o7, s11, u12, a11, c15, d7;
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
        ...
        case 1:
          return t2.trys.push([1, 3, , 4]), [4, k3(o7)];
        case 2:
          return a11 = t2.sent(), u12 = a11.subwindowCommonModule, [3, 4];
        case 3:
          throw c15 = t2.sent(), i.debug(c15), h(N);
        case 4:
...
function me(i6) {
  return __awaiter(this, void 0, void 0, function() {
    var e10, o7, s11, u12, a11, c15, f12, g8, b8, y5;
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return (e10 = O2(i6.url)) ? (le(true), [4, de()]) : [2, Promise.reject(h(I, "params.url must be liff url"))];
        case 1:
          return t2.sent(), o7 = i6.url, s11 = i6.appData, (u12 = new URL(o7)).searchParams.append(L, "true"), [4, ne()];
        case 2:
          return a11 = t2.sent(), u12.searchParams.append(o5, a11.identification.identifier), u12.searchParams.append(c9, a11.identification.cryptoKey), u12.hostname = function(e11) {
            var t3 = __read(e11.split(".")), i7 = t3[0], o8 = t3.slice(1);
            return __spreadArray(["".concat(i7, "-ext")], __read(o8), false).join(".");
          }(u12.hostname), c15 = u12.toString(), Z2("ios" !== e7() || E2() ? window.open("", "liffsubwindow", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : window.open()), [4, k3(e10)];
        case 3:
          if (f12 = t2.sent(), g8 = f12.origin, b8 = f12.subwindowCommonModule, !(y5 = $3()))
            throw h(n3);
          return b8 ? (function(e11) {
            q2 = e11;
          }(g8), a11.listen(ce), a11.setData("appData", s11), window.addEventListener("message", ae), y5.location.href = c15, S5 = function(e11, t3) {
            var n6 = $3(), r10 = { type: p };
...
function pe(i6) {
  return __awaiter(this, void 0, void 0, function() {
    var o7, s11, u12, a11, c15, f12, d7, m12, p12, h6, w6, b8, y5, S5, O4 = this;
    return __generator(this, function(P3) {
      switch (P3.label) {
        case 0:
          if (o7 = i6.msit, s11 = i6.mstChallenge, u12 = i6.reconnectCount, a11 = void 0 === u12 ? 0 : u12, c15 = function() {
            return __awaiter(O4, void 0, void 0, function() {
              return __generator(this, function(e10) {
                switch (e10.label) {
                  ...
                  case 1:
                    return e10.sent(), [4, pe({ msit: o7, mstChallenge: s11, onSuccess: i6.onSuccess, onError: i6.onError, reconnectCount: a11 + 1 })];
                  case 2:
                    return e10.sent(), [2];
                }
                var t2;
          ...
          }, m12 = Date.now(), null === ve && (ve = m12), p12 = m12 - ve, a11 >= 10 || p12 > 6e5)
            return d7(h(e2, "Failed to connect")), [2];
          P3.label = 1;
        case 1:
          return P3.trys.push([1, 3, , 5]), [4, p6(l7("subWindowSubscribe"), { method: "POST", body: JSON.stringify({ msit: o7, mstChallenge: s11 }) })];
        case 2:
          return h6 = P3.sent(), [3, 5];
        case 3:
          return P3.sent(), [4, c15()];
        case 4:
          return P3.sent(), [2];
        case 5:
        ...
        case 8:
          return b8 = P3.sent(), w6 = b8 ? h(I, b8.errorDetail) : h(e2, "Some error happened in the server"), d7(w6), [3, 17];
        case 9:
          return 200 !== h6.status ? [3, 16] : [4, he(h6)];
        case 10:
          if (!(b8 = P3.sent()))
            return d7(h(e2, "Some error happened in the server")), [2];
          switch (y5 = b8.status, S5 = b8.result, y5) {
            case C.ERROR:
              return [3, 11];
            case C.CLOSE:
            case C.CANCEL:
        ...
        case 14:
          d7(h(e2, "Some error happened in the server")), P3.label = 15;
        case 15:
          return [3, 17];
        case 16:
          d7(h(e2, "Some error happened in the server")), P3.label = 17;
        case 17:
          return [2];
      }
    });
...
function be(e10) {
  var t2 = e10.appData, n6 = e10.native, r10 = c5().liffId, i6 = M(), o7 = O2(e10.url);
  if (!r10)
    return Promise.reject(h(t, "liffId is invalid"));
  if (!i6)
    return Promise.reject(h(t, "mst_challenge is invalid"));
  if (!o7)
    return Promise.reject(h(I, "params.url must be liff url"));
  var s11 = Object.assign({}, ge, n6);
  return function(e11) {
    var t3 = e11.mainLiffId, n7 = e11.subLiffId, r11 = e11.mstChallenge, i7 = e11.appData, o8 = e11.view;
    return t3 && r11 ? f4(l7("subWindowGetMSIT"), { method: "POST", body: JSON.stringify({ mainLiffId: t3, subLiffId: n7, mstChallenge: r11, appData: i7, view: o8 }) }) : Promise.reject(h(I, "no proper argument"));
...
function ye(e10) {
  if (!e10.mst || !e10.status)
    return Promise.reject(h(I, "no proper argument"));
...
function Ie(e10) {
  ...
  return t2 && n6 ? f4(l7("subWindowGetMSTByMSIT"), { method: "POST", body: JSON.stringify({ msit: t2, mstVerifier: n6 }) }) : Promise.reject(h(I, "no proper argument"));
}
function Oe(e10) {
  var t2 = e10.mst;
  return t2 ? f4(l7("subWindowGetAppData"), { method: "POST", body: JSON.stringify({ mst: t2 }) }) : Promise.reject(h(I, "no proper argument"));
}
  ...
  return void 0 === n6 && (n6 = {}), Se(), u3() ? function(n7) {
    return void 0 === n7 && (n7 = {}), __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(t2) {
        switch (t2.label) {
          case 0:
            return (e10 = D2()) ? [4, ye({ mst: e10, status: C.CANCEL, result: n7 })] : [2, Promise.reject(h(t, "mst is invalid"))];
          case 1:
  ...
  return void 0 === n6 && (n6 = {}), Se(), u3() ? function(n7) {
    return void 0 === n7 && (n7 = {}), __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(t2) {
        switch (t2.label) {
          case 0:
            return (e10 = D2()) ? [4, ye({ mst: e10, status: C.SUBMIT, result: n7 })] : [2, Promise.reject(h(t, "mst is invalid"))];
          case 1:
            return r10 = t2.sent(), Y2(true), [2, r10];
        }
      });
  ...
  return Se(), u3() ? function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(t2) {
        switch (t2.label) {
          case 0:
            return false !== X2() ? [3, 2] : (e10 = D2()) ? [4, ye({ mst: e10, status: C.CLOSE, result: {} })] : [2, Promise.reject(h(t, "mst is invalid"))];
          case 1:
            t2.sent(), t2.label = 2;
          case 2:
            return r8(), [2];
...
var s7 = function() {
  ...
  this.type = "sync", this.fns = /* @__PURE__ */ new Set(), this.on = function(n6) {
    ...
    for (var i6, s11, a11 = [], o7 = 0; o7 < arguments.length; o7++)
      a11[o7] = arguments[o7];
    try {
      for (var l12 = __values(e10.fns), c15 = l12.next(); !c15.done; c15 = l12.next()) {
        var f12 = c15.value;
        f12.apply(void 0, __spreadArray([], __read(a11), false));
      }
    } catch (u12) {
      i6 = { error: u12 };
    } finally {
...
var a7 = function() {
  ...
  this.type = "async", this.fns = /* @__PURE__ */ new Set(), this.on = function(n6) {
    ...
    for (var a11 = [], o7 = 0; o7 < arguments.length; o7++)
      a11[o7] = arguments[o7];
          ...
          case 0:
            ...
            try {
              for (s12 = __values(this.fns), o8 = s12.next(); !o8.done; o8 = s12.next())
                l12 = o8.value, e10.push(l12.apply(void 0, __spreadArray([], __read(a11), false)));
            } catch (u12) {
              c15 = { error: u12 };
            } finally {
              try {
...
// node_modules/@liff/login/lib/index.es.js
var _4 = function(i6) {
  var m12, g8 = I2(43), _6 = w((0, import_tiny_sha256.default)(g8)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, ""), b8 = c5();
  if (!b8 || !b8.liffId)
    throw h(T, "You need to define `liffId` for liff.login()");
  var v8 = { app_id: b8.liffId, state: I2(12), response_type: "code", code_challenge_method: "S256", code_challenge: _6, liff_sdk_version: r4() };
  i6 && i6.redirectUri && (v8.redirect_uri = i6.redirectUri), d3() && !u3() && ((null === (m12 = re()) || void 0 === m12 ? void 0 : m12.isReady()) ? v8.redirect_uri = window.location.href : v8.disable_auto_login = "true"), Q({ codeVerifier: g8 });
  var w6 = l7("authorize") + "?" + b.stringify(v8);
  i.debug("[Redirect] ".concat(w6)), window.location.href = w6;
};
var b5 = function(o7) {
  function r10() {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(e10) {
      switch (e10.label) {
        ...
        case 1:
          return t2 = e10.sent(), n6 = "".concat(a8), !t2.languages[n6] && a8.includes("-") && (n6 = a8.split("-")[0]), t2.languages[n6] || (n6 = "en"), [4, f4("".concat("https://liffsdk.line-scdn.net/xlt", "/").concat(t2.languages[n6]), { method: "GET", headers: { Accept: "application/json" } })];
        case 2:
...
function f7(t2) {
  if (null === c11)
    throw h(i3, "please call xlt after liff.init");
  return c11[t2];
}
var p9 = function(i6) {
  function r10() {
...
function Le(t2) {
  var n6 = E3(), r10 = (null == n6 ? void 0 : n6.menuColorSetting) || { adaptableColorSchemes: ["light"], lightModeColor: Te, darkModeColor: Ae }, o7 = r10.adaptableColorSchemes, i6 = r10.lightModeColor, a11 = r10.darkModeColor, c15 = o7.includes("dark");
  t2.matches && c15 ? Ne(__assign(__assign({}, Ae), a11)) : Ne(__assign(__assign({}, Te), i6));
}
function Ne(e10) {
  var t2 = e10.iconColor, n6 = e10.statusBarColor, r10 = e10.titleTextColor, o7 = e10.titleSubtextColor, i6 = e10.titleButtonColor, a11 = e10.titleBackgroundColor, c15 = e10.progressBarColor, s11 = e10.progressBackgroundColor, u12 = e10.titleButtonAreaBackgroundColor, d7 = e10.titleButtonAreaBorderColor, h6 = e10.baseBackgroundColor, p12 = e10.baseTextColor, v8 = e10.lightButtonBorderColor;
  De("--liff-base-background-color", h6), De("--liff-base-text-color", p12), De("--liff-base-background-rgb-color", s3(h6)), De("--liff-base-text-rgb-color", s3(p12)), De("--liff-light-button-border-color", v8), De("--liff-title-text-color", r10), De("--liff-title-background-color", a11), De("--liff-title-button-color", i6), De("--liff-icon-color", t2), De("--liff-status-bar-color", n6), De("--liff-title-subtext-color", o7), De("--liff-progress-bar-color", c15), De("--liff-progress-background-color", s11), De("--liff-title-button-area-background-color", f(u12)), De("--liff-title-button-area-border-color", f(d7));
}
function De(e10, t2) {
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return [4, y3()];
        case 1:
          return (t2 = n6.sent()) ? (t2.install(e10, Ue), [2]) : [2];
      }
    });
  });
}
...
function je(e10, o7) {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a11, c15, s11, l12, f12, p12, v8, m12, w6, b8, g8, k5, C5, F5;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return t2 = e10.split("."), i6 = __read(t2, 3), a11 = i6[0], c15 = i6[1], s11 = i6[2], l12 = JSON.parse(c3.decode(a11)), f12 = JSON.parse(c3.decodeUnicode(c15)), p12 = d(c3.decode(s11)), v8 = d("".concat(a11, ".").concat(c15)), [4, Pe2()];
        case 1:
          if (m12 = n6.sent(), !(w6 = m12.keys.find(function(e11) {
            return e11.kid === l12.kid;
          })))
            return [3, 6];
          if (delete w6.alg, "ES256" !== l12.alg)
            throw h(_, 'Invalid "alg" value in ID_TOKEN');
          b8 = void 0, n6.label = 2;
        case 2:
          return n6.trys.push([2, 4, , 5]), [4, We(w6, v8, p12)];
        case 3:
          return b8 = n6.sent(), [3, 5];
        case 4:
          throw g8 = n6.sent(), h(_, "".concat("Failed to use Crypto API to verify ID_TOKEN", ": ").concat(g8));
        case 5:
          if (b8) {
            if (k5 = f12.iss !== "https://access.".concat("line.me"), C5 = f12.aud !== o7, F5 = 1e3 * f12.exp < Date.now(), k5)
              throw h(_, 'Invalid "iss" value in ID_TOKEN');
            if (C5)
              throw h(_, 'Invalid "aud" value in ID_TOKEN');
            if (F5)
              throw h(_, 'Invalid "exp" value in ID_TOKEN');
            return [2, f12];
          }
          throw h(_, "Invalid signature in ID_TOKEN");
        case 6:
          throw h(_, 'Invalid "kid" value in ID_TOKEN');
        case 7:
          return [2];
      }
    });
...
function Ke(e10) {
  var t2 = e10.pathname, n6 = e10.query, r10 = n6 ? "?".concat(b.stringify(n6)) : "", o7 = "".concat("liff://").concat(t2).concat(r10);
  location.href = o7;
}
var Me = null;
function Re() {
  "boolean" == typeof Me && i.warn("liff.init is not expected to be called more than once"), Me = !!O3() || !(!u3() || b.parse(window.location.hash).feature_token || w2()) && (P(true), true);
}
function Je() {
  return Boolean(Me);
}
...
function ze(e10) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return t2 = b.parse(window.location.hash), r10 = function(e11) {
            for (var t3, n7, r11 = [], i7 = 1; i7 < arguments.length; i7++)
              r11[i7 - 1] = arguments[i7];
            var a12 = function(t4) {
            ...
            try {
              for (var c15 = __values(r11), s11 = c15.next(); !s11.done; s11 = c15.next()) {
                a12(s11.value);
              }
            } catch (l12) {
              t3 = { error: l12 };
              ...
              try {
                s11 && !s11.done && (n7 = c15.return) && n7.call(c15);
              } finally {
                if (t3)
                  throw t3.error;
              }
            ...
            return e11;
          }({ access_token: x2(), context_token: K(), feature_token: w2(), id_token: X(), client_id: j2(), mst_challenge: M(), mst_verifier: h2(), msit: v2() }, t2), Je() ? e3() ? [4, qe(e10)] : [3, 2] : [3, 3];
        case 1:
          i6 = n6.sent().featureToken, r10.feature_token || (r10.feature_token = i6), n6.label = 2;
        case 2:
          (a11 = m2(e10)) && (r10.client_id = a11), n6.label = 3;
        case 3:
          return [2, r10];
      }
    });
...
function Qe(e10) {
  var r10, o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a11, c15, l12, f12, d7, h6, v8, b8, g8, C5, F5, I6, y5, _6, B2;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
        ...
        case 2:
          if (t2 = n6.sent(), i6 = t2.access_token, a11 = t2.context_token, c15 = t2.feature_token, l12 = t2.id_token, f12 = t2.client_id, d7 = t2.mst_verifier, h6 = t2.mst_challenge, v8 = t2.msit, a11) {
            if ("string" != typeof a11)
              throw h(i3, "Cannot get context token, perhaps there is an incorrect parameter in permanent link");
            I3(He(a11));
          }
          if (void 0 !== (null === (r10 = E3()) || void 0 === r10 ? void 0 : r10.liffId) && (null === (o7 = E3()) || void 0 === o7 ? void 0 : o7.liffId) !== e10.liffId)
            throw h(i3, "Invalid LIFF ID");
          return !d3() && c15 && (!function(e11, t3) {
            T4("multipleLiffTransition") && Ke({ pathname: "app/".concat(e11), query: { feature_token: t3 } });
          }(e10.liffId, c15), Je() && U2(c15)), h6 && R2(h6), d7 && A3(d7), f12 && F3(f12), v8 && C3(v8), window.addEventListener("pageshow", Ge), e3() ? [3, 5] : c15 && i6 ? [3, 5] : Je() ? (b8 = L2(location.href, { "liff.hback": "2" }), _4({ redirectUri: b8 }), [4, new Promise(function() {
          })]) : [3, 4];
        case 3:
          n6.sent(), n6.label = 4;
        case 4:
          throw _4(), h(i3, "Failed to parse feature_token or access_token");
        case 5:
          return i6 && c15 ? [4, v4(i6)] : [3, 7];
        case 6:
          if (g8 = n6.sent(), C5 = g8.client_id, F5 = g8.expires_in, I6 = m2(e10.liffId), C5 !== I6)
            throw _4(), h(i3, "Failed to verify access_token");
          U2(c15), q(new Date(Date.now() + 1e3 * F5)), B(i6), n6.label = 7;
        case 7:
          return [4, Ve(v8, d7)];
        case 8:
          return (y5 = n6.sent()) ? (L3(y5), [4, Oe({ mst: y5 })]) : [3, 10];
        case 9:
          (_6 = n6.sent().data) && N2(JSON.stringify(_6)), n6.label = 10;
        case 10:
          return l12 && !X() && G(l12), l12 && f12 && !Z() ? [4, je(l12, f12)] : [3, 12];
        case 11:
          (B2 = n6.sent()) && $2(B2), n6.label = 12;
        case 12:
          return [2];
      }
    });
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        ...
        case 1:
          if (a11 = n6.sent(), !(c15 = a11.contextToken))
            throw h(i3, "Can not get context from server.");
          if (!(s11 = He(c15)))
            throw h(i3, "Invalid context token.");
          return [2, s11];
      }
    });
  });
...
function Ze(e10) {
  return __awaiter(this, void 0, void 0, function() {
    var r10, o7, i6, a11 = this;
    return __generator(this, function(c15) {
      switch (c15.label) {
        case 0:
          r10 = function() {
            return __awaiter(a11, void 0, void 0, function() {
              var t2, r11, o8, i7, a12, c16;
              return __generator(this, function(n6) {
                switch (n6.label) {
                  case 0:
                    return [4, (s11 = c5(), l12 = b.parse(window.location.search), f12 = J(), u12 = { grant_type: "authorization_code", client_id: l12.liffClientId, appId: s11.liffId, code: l12.code, code_verifier: f12.codeVerifier, redirect_uri: s11.redirectUri || l12.liffRedirectUri, id_token_key_type: "JWK" }, d7 = b.stringify(u12), f4(l7("token"), { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8" }, body: d7 }))];
                  case 1:
                  ...
                  case 2:
                    (a12 = n6.sent()) && $2(a12), n6.label = 3;
                  case 3:
                    return (c16 = b.parse(location.hash).context_token) ? (I3(He(c16)), [3, 6]) : [3, 4];
                  case 4:
                    return [4, Ye()];
                  case 5:
                    n6.sent(), n6.label = 6;
                ...
                var s11, l12, f12, u12, d7;
              });
            });
          }, c15.label = 1;
        case 1:
          return c15.trys.push([1, 3, , 4]), [4, r10()];
        case 2:
          return c15.sent(), [3, 4];
        case 3:
          throw o7 = c15.sent(), i6 = o7, W(), i6;
        case 4:
          return [2];
      }
    });
...
function $e() {
  return __awaiter(this, void 0, void 0, function() {
    var e10, r10, o7, i6, a11, c15, l12 = this;
    return __generator(this, function(f12) {
      switch (f12.label) {
        ...
        case 2:
          return (e10 = r10).isReady() ? (o7 = I2(8), [4, e10.getData("appData")]) : [3, 8];
        case 3:
          return i6 = f12.sent(), a11 = i6.eventName, c15 = i6.data, a11 !== d4.NOT_FOUND ? [3, 6] : [4, e10.teardown()];
        case 4:
          return f12.sent(), [4, $e()];
        case 5:
          return [2, f12.sent()];
          ...
          return se() ? [3, 10] : [4, new Promise(function(e11) {
            window.addEventListener("message", function(e12) {
              return function t2(n6) {
                ...
                if (r11) {
                  var a12 = r11.type, c16 = r11.message;
                  a12 === p && (window.removeEventListener("message", t2), c16 && N2(c16), oe(i7), o8 && o8.postMessage && o8.postMessage({ status: p }, i7), e12());
                }
              };
            }(e11));
          })];
...
var et = new (function() {
  function e10() {
    ...
    this.getAndValidateContext = function() {
      var e12 = E3();
      if (!e12)
        throw h(i3, "Could not get Context from server.");
      if (!e12.endpointUrl)
        throw h(i3, "Could not get endpointUrl from server.");
      if (!e12.permanentLinkPattern)
        throw h(i3, "Could not get permanentLinkPattern from server.");
      return e12;
    }, this.decodeState = function(t2) {
      var n6 = e11.getAndValidateContext();
      t2 = t2.replace(/\n/g, "%0D%0A");
      var r10 = !n6.endpointUrl.startsWith("/?") && n6.endpointUrl.includes("/?") || !n6.endpointUrl.startsWith("/#") && n6.endpointUrl.includes("/#") || n6.endpointUrl.endsWith("/") || !t2.startsWith("/?") && t2.includes("/?") || !t2.startsWith("/#") && t2.includes("/#") || t2.endsWith("/"), o7 = new URL(n6.endpointUrl), i6 = o7.origin, a11 = o7.pathname, c15 = o7.search, s11 = new URL("".concat(i6).concat(e11.attachSlashAtStart(t2))), l12 = s11.pathname, f12 = s11.search, u12 = s11.hash, d7 = "".concat(c15).concat(c15 ? f12.replace(/\?/g, "&") : f12), h6 = "".concat(a11).concat(e11.attachSlashAtStart(l12)).replace("//", "/");
  ...
  return e10.prototype.attachSlashAtStart = function(e11) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            if (e11 = b.parse(window.location.search), "string" != typeof (t2 = e11["liff.state"]))
              return [2];
            n6.label = 1;
          case 1:
            return n6.trys.push([1, 4, , 5]), r10 = location.href, (o7 = this.decodeState(t2)) === r10 ? [3, 3] : (e11["liff.hback"] ? location.replace(L2(o7, { "liff.hback": e11["liff.hback"] })) : location.replace(o7), [4, new Promise(function() {
            })]);
          case 2:
            n6.sent(), n6.label = 3;
          case 3:
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          if (!e10.liffId)
            throw h(T, "liffId is necessary for liff.init()");
          return l4(e10), !u3() && e3() && (z() || o4()), t2 = b.parse(window.location.search), !d3() || u3() ? [3, 2] : [4, $e()];
        case 1:
          n6.sent(), n6.label = 2;
        case 2:
          if (t2.error && t2.liffOAuth2Error)
            throw a11 = t2.error, c15 = t2.error_description, l12 = c15.replace(/\+/g, " "), f12 = "".concat(a11, ": ").concat(l12), h(i3, f12);
          return o7 = t2.code, i6 = J(), Boolean(o7 && !e3() && i6 && i6.codeVerifier) ? [4, Ze(t2.liffClientId)] : [3, 4];
        case 3:
          n6.sent(), n6.label = 4;
        case 4:
        ...
        case 10:
          return n6.sent(), x(window.location.href), [2];
      }
      var o7, i6, a11, c15, l12, f12;
    });
  });
}
var nt = function(e10, t2) {
...
var rt = function(e10) {
  ...
  return t2 && e10 && (t2 = t2.replace(/\d{1,2}\.\d{1,2}\.\d{1,3}/, e10)), nt(t2, "LUI_ALERT_URL is not defined");
};
var ot = function() {
  return __awaiter(void 0, void 0, void 0, function() {
    var e10;
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          ...
          }(), e10 ? [3, 2] : [4, nt("https://static.line-scdn.net/lui/edge/versions/1.13.0/luivendor.js", "LUI_VENDOR_URL is not defined")];
        case 1:
          t2.sent(), t2.label = 2;
        case 2:
          return [4, rt(e10)];
        case 3:
          return t2.sent(), [4, (n6 = I2(6), new Promise(function() {
...
function it() {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return u3() || "android" !== e7() || ((e10 = b.parse(window.location.search))[o5] || e10.liffIsEscapedFromApp) ? [3, 6] : e10.liffClientId && document.referrer.includes("access.".concat("line.me")) ? (window.location.href = "".concat(window.location.href, "&liffIsEscapedFromApp=true"), [2]) : e10.liffClientId && document.referrer.includes("android-app://") ? [4, ot()] : [3, 2];
        case 1:
          t2.sent(), t2.label = 2;
        case 2:
          return e10.liffClientId && "" === document.referrer && 1 === window.history.length ? [4, ot()] : [3, 4];
        case 3:
          t2.sent(), t2.label = 4;
        case 4:
          return !document.referrer.includes("liffClientId") || document.referrer.includes("liffIsEscapedFromApp") ? [3, 6] : [4, ot()];
        case 5:
          t2.sent(), t2.label = 6;
        case 6:
          return [2];
...
var at = function(e10) {
  function r10() {
    ...
    return t2.hooks = { before: new a7(), after: new a7() }, t2.internalHooks = { beforeFinished: new a7(), beforeSuccess: new a7(), error: new a7() }, t2;
  }
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(n6) {
        switch (n6.label) {
          ...
          case 2:
            return n6.trys.push([2, 9, , 11]), [4, Promise.all([Oe2(this.liffForWindow), tt(e11, this.internalHooks.beforeFinished.call)])];
          case 3:
...
function k4(r10) {
  return __awaiter(this, void 0, void 0, function() {
    var e10, i6, o7, u12, f12, h6, v8;
    return __generator(this, function(t2) {
      switch (t2.label) {
        case 0:
          return function(e11) {
            if (!F.includes(e11))
              throw h(I, "Unexpected permission name.");
            var t3 = E3();
        ...
        case 1:
          ...
          try {
            ...
            try {
              f12 && !f12.done && (v8 = u12.return) && v8.call(u12);
            } finally {
              if (h6)
                throw h6.error;
            }
...
var E5 = function() {
  ...
  return n6.prototype.setup = function() {
    ...
    P2("submit", this.onSubmit), P2("close", this.onClose), P2("cancel", this.onCancel), P2("error", this.onError), T5 = void 0;
  }, n6.prototype.open = function() {
    var e10 = c5().liffId;
    e10 ? x3({ url: "".concat("https://liff.line.me/1656032314-Xgrw5Pmk"), appData: { liffId: e10, channelId: m2(e10), accessToken: x2() } }) : this.reject(h(t, "liffId is required"));
  }, n6;
}();
function _5() {
  return __awaiter(this, void 0, void 0, function() {
...
function R3(n6, o7) {
  var s11 = this;
  return function() {
    for (var a11 = [], c15 = 0; c15 < arguments.length; c15++)
      a11[c15] = arguments[c15];
    return __awaiter(s11, void 0, void 0, function() {
      var e10, s12, c16;
      return __generator(this, function(t2) {
        switch (t2.label) {
          case 0:
            return e10 = (a11.length > 0 ? a11[a11.length - 1] : {}).ignorePermissionCheck, s12 = void 0 !== e10 && e10, [4, k4(o7)];
          case 1:
          ...
          case 3:
            return t2.sent(), [3, 5];
          case 4:
            s12 && a11.pop(), t2.label = 5;
          case 5:
            return [4, n6.apply(void 0, __spreadArray([], __read(a11), false))];
          case 6:
            return [2, t2.sent()];
        }
      });
...
function p10(n6) {
  if (!function(n7) {
    ...
    throw h(I, "Invalid parameters for liff.openWindow()");
  var u12 = r5();
  if (u3())
    if (null !== u12 && "ios" === e7() && u2(u12, "9.19") >= 0 || !window._liff.postMessage) {
...
var c12 = function(r10) {
  if ("403" === r10.code) {
    var e10 = "12.0.0" === r5(), o7 = "ios" === e7(), n6 = E2();
...
var I4 = function(u12) {
  ...
  return __extends(d7, u12), Object.defineProperty(d7, "CUSTOMPLACEID_INIT", { get: function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      var t2, i6, r10, u13, d8, h6, g8, I6, m12, L4, S5, v8;
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            if (t2 = b.parse(window.location.search), this.prepareReferrer(t2), i6 = E3(), !(r10 = null == i6 ? void 0 : i6.utsTracking))
              return [2];
          ...
          case 5:
            (S5 = e10.sent()) && (i.debug("[LIFFUTS][mid] ".concat(S5)), this.uts.setMid(S5)), (null == i6 ? void 0 : i6.tid) && (i.debug("[LIFFUTS][tid] ".concat(i6.tid)), this.uts.setTid(i6.tid)), this.referrer && (i.debug("liff.ref.referrer", this.referrer), this.uts.setSessionParams(this.referrer)), d8 && this.setLiffId(d8), this.setIsLoggedIn(e3()), this.setVersion(r4()), v8 = U(location.href), i.debug("[LIFFUTS][url] ".concat(v8)), this.uts.setUrl(v8), this.liffCore.analytics = this.uts, this.injected = true, e10.label = 6;
          case 6:
            return [2];
        }
      });
...
var m10 = /([\x90\x9D\x81\x8D\x8F<"{|}>\\^`“›„•‚ŽŠ…’—ž–‘”‡™‰ŒšŸ‹œ†¥¿©áÄýÍÎðô]|\n|.*#.*#|%(?![0-9A-Fa-f]{2})[^%]{0,2})/;
var g7 = function(t2) {
  if (m10.test(t2))
    throw h(I, "invalid URL.");
  var n6 = new URL(t2), r10 = n6.username, e10 = n6.password, i6 = n6.hash, o7 = n6.search;
  return { username: r10, password: e10, pathname: n6.pathname, hash: i6, origin: n6.origin, search: o7.replace(/(?:^|;|&)([^;&]*)[;&]*(?=($|;|&))/g, "$1&").replace(/&+$/g, "").replace(/^\?&/, "?") };
};
var d6 = function(t2) {
  return t2.substring(1).split("&").filter(function(t3) {
    return !/^liff\./.test(t3) && Boolean(t3);
  });
};
var v7 = function(t2, n6) {
  var r10 = t2.substring(n6.length);
  return "/" === r10 ? "" : (r10.length > 0 && "/" !== r10[0] && (r10 = "/" + r10), r10);
};
var x4 = function(r10, e10) {
  var i6, a11, o7, s11 = function(r11, e11) {
    for (var i7 = __spreadArray([], __read(r11), false), a12 = 0; a12 < e11.length; a12++) {
      var o8 = e11[a12], s12 = i7.indexOf(o8);
      s12 > -1 && i7.splice(s12, 1);
    }
    return i7;
  }((i6 = d6(r10).join("&"), a11 = new URLSearchParams(i6).toString().split("&"), o7 = i6.split("&"), a11.map(function(t2, n6) {
    return t2.endsWith("=") && !o7[n6].endsWith("=") ? t2.slice(0, -1) : t2;
  })), d6(e10)).join("&");
  return "" !== s11 ? "?".concat(s11) : "";
};
var w5 = function(t2) {
  var n6 = new RegExp("^".concat(a2.join("|"))), r10 = t2.substring(1).split("&").filter(function(t3) {
    return !n6.test(t3) && Boolean(t3);
  }).join("&");
  return r10 ? "#".concat(r10) : "";
};
var U3 = function(t2) {
  function n6() {
    var n7 = null !== t2 && t2.apply(this, arguments) || this;
    return n7.extraParams = "", n7.getAndValidateContext = function() {
      var t3 = E3();
      if (!t3)
        throw h(i3, "Could not get Context from server.");
      if (!t3.endpointUrl)
        throw h(i3, "Could not get endpointUrl from server.");
      if (!t3.permanentLinkPattern)
        throw h(i3, "Could not get permanentLinkPattern from server.");
      return t3;
    }, n7.createUrl = function() {
      var t3 = n7.getAndValidateContext(), r10 = window.location, e10 = r10.pathname, i6 = r10.search, a11 = r10.hash, s11 = r10.origin, l12 = new URL(t3.endpointUrl);
      if (l12.origin !== s11 || !n7.isAncestor(l12.pathname, e10))
        throw h(T, "Current page is not under entrypoint.");
      var p12 = e10.substring(l12.pathname.length);
      p12.length > 0 && "/" !== p12[0] && (p12 = "/" + p12);
      var m12 = new RegExp("^".concat(a2.join("|"))), g8 = a11.substring(1).split("&").filter(function(t4) {
        return !m12.test(t4) && Boolean(t4);
      }).join("&"), d7 = g8 === l12.hash.substring(1) ? "" : g8, v8 = function(t4) {
        return t4.substring(1).split("&").filter(function(t5) {
          return !/liff\.state/.test(t5) && Boolean(t5);
        });
      }, x5 = v8(i6), w6 = v8(l12.search);
      n7.extraParams && x5.push(n7.extraParams);
      for (var U4 = 0; U4 < w6.length; U4++) {
        var b8 = w6[U4], P3 = x5.indexOf(b8);
        P3 > -1 && x5.splice(P3, 1);
      }
      var y5 = x5.join("&"), L4 = "".concat(p12).concat("" !== y5 ? "?".concat(y5) : "").concat(d7 ? "#".concat(d7) : "");
      return "".concat(s2).concat(c5().liffId).concat(L4);
    }, n7.createUrlBy = function(t3) {
      return __awaiter(n7, void 0, void 0, function() {
        var n8, r10, e10, o7;
        return __generator(this, function(i6) {
          if (!(n8 = c5().liffId))
            throw h(i3, "Should run after liff init.");
          if (r10 = this.getAndValidateContext(), e10 = g7(t3), o7 = new URL(r10.endpointUrl), e10.username !== o7.username || e10.password !== o7.password)
            throw h(I, "invalid URL.");
          if (o7.origin !== e10.origin || !this.isAncestor(o7.pathname, e10.pathname))
            throw h(I, "invalid URL.");
          return [2, s2.concat(n8, v7(e10.pathname, o7.pathname), x4(e10.search, o7.search), w5(e10.hash))];
        });
      });
    }, n7.setExtraQueryParam = function(t3) {
      n7.extraParams = t3;
    }, n7.isAncestor = function(t3, n8) {
      return 0 === n8.indexOf(t3) && (t3.endsWith("/") && (t3 = t3.substring(0, t3.length - 1)), void 0 === n8[t3.length] || "/" === n8[t3.length]);
    }, n7.install = function() {
      return { createUrl: n7.createUrl, createUrlBy: n7.createUrlBy, setExtraQueryParam: n7.setExtraQueryParam };
    }, n7;
  }
...
function c14(e10, r10, o7, i6) {
  ...
  return new Promise(function(t2) {
    ...
    !function(t3, e11) {
      n5[t3] = e11;
    }(r10, f12), e10.addEventListener(c15, f12, !!a10 && i6);
  });
}
function u11(t2, o7, n6, i6) {
  if (void 0 === n6 && (n6 = {}), "object" != typeof t2 || !t2.postMessage)
    throw h(I, "target must be window object");
  if ("string" != typeof o7)
    throw h(I, "keyname must be string");
  if ("object" != typeof n6)
    throw h(I, "incorrect body format. It should be Object or Array comprised of Object");
  if (!i6)
    throw h(I, "serverEndPointUrl isn't passed. please fill up with proper url");
  if ("*" === i6)
...
var I5 = function() {
  ...
  return i6.getInstance = function() {
    ...
    u3() || ("ios" !== e7() || E2() ? this.popupWindow = window.open("", "liffpopup", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : this.popupWindow = window.open());
  }, i6.prototype.openAnotherWindow = function() {
    if (u3() && this.payloadToShareTargetPicker)
      t2 = this.liffId, e10 = this.ott, i7 = this.payloadToShareTargetPicker, o7 = { liffId: t2, ott: e10, data: JSON.stringify(i7), closeModals: false }, location.href = "".concat("line://picker", "?").concat(b.stringify(o7));
    else {
      ...
      !function(t3, e11, i8) {
        ...
        t3.location.href = "".concat(l7("shareTargetPicker"), "?").concat(b.stringify(r10));
      ...
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            ...
            return this.abortController && (t2 = this.abortController.signal), i7 = { liffId: this.liffId, ott: this.ott }, [4, f4("".concat(l7("shareTargetPickerResult"), "?").concat(b.stringify(i7)), { method: "POST", signal: t2, headers: { Accept: "application/json", "Content-Type": "application/x-www-form-urlencoded" }, body: "result=CANCEL" })];
          case 1:
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(e10) {
        if (!this.ott)
          throw new Error("need to call with ott in client");
        return this.abortController && (t2 = this.abortController.signal), i7 = { liffId: this.liffId, ott: this.ott }, i.debug("fetch: getShareResult"), [2, f4("".concat(l7("shareTargetPickerResult"), "?").concat(b.stringify(i7)), { method: "GET", headers: { Accept: "application/json" }, signal: t2 })];
      });
    });
  ...
  function l12() {
    ...
    return i6.shareTargetPicker = function(r11, l13) {
      return void 0 === l13 && (l13 = {}), __awaiter(i6, void 0, void 0, function() {
        var t2, i7, h6, c15, b8, y5, v8;
        return __generator(this, function(e10) {
          switch (e10.label) {
            case 0:
              if (C4.shareTargetPicker(), !r11 || !Array.isArray(r11) || 0 === r11.length)
                throw h(I, "no proper argument");
              if (r11.length > c2)
                throw h(I, "exceed the limit of num of messages");
              if (!(t2 = c5().liffId))
                throw h(T);
              window.liff && (i7 = window.liff).analytics && m9(i7.analytics), h6 = void 0 === l13.isMultiple || l13.isMultiple, e10.label = 1;
            case 1:
              return e10.trys.push([1, 3, , 4]), c15 = I5.getInstance(), b8 = r5(), y5 = { waitForSubwindowResult: true }, u3() && b8 && u2(b8, "10.11.0") < 0 && (y5.waitForSubwindowResult = false), [4, c15.init({ messages: r11, isMultiple: h6, referrer: { liffId: t2, url: location.origin }, options: y5 })];
            case 2:
              return [2, e10.sent()];
            case 3:
              throw (v8 = e10.sent()) instanceof g ? v8 : h(N, v8.message);
            case 4:
              return [2];
          }
        });
